...
namespace DragonJack
{
    ...
    public class DragonJackGame
    {
        ...
        public const int maxCardsWidth = (8 + (decksCount - 1)) * 5;
        ...
        static void Main()
        {
            ...
            {
                Console.WriteLine("Error: Wrong calculating of points!");
            }
        ...
        public static int getWinner(int playerSum, int dealerSum, bool playerJack, bool dealerJack)
        {
            ...
            else if (playerSum > 21 || (!playerJack && dealerJack))
                return 2; //Dealer won from busting player or from dragon jack
            //No one got over 21 so who has more points he wins :
